package cn.techoc.dynamicdatasourcemybatis.config;
...
@Configuration
@MapperScan(basePackages = "cn.techoc.dynamicdatasourcemybatis.mapper.orders", sqlSessionTemplateRef = "ordersSqlSessionTemplate")
public class MyBatisOrdersConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 设置 entity 所在包
        bean.setTypeAliasesPackage("cn.techoc.dynamicdatasourcemybatis.entity");
        // 设置 config 路径
