...
import cn.techoc.dynamicdatasourcespringdatajpa.constant.DBConstants;
...
@EnableJpaRepositories(
        ...
        basePackages = {"cn.techoc.dynamicdatasourcespringdatajpa.Repository.orders"}) // 设置 Repository 接口所在包
